...
// Provides functions to execute db functions and transactions
...
// Executes function within a db transaction
...
// Perform transfer beetween accounts
// Creates transfer record, add account entries, update accounts balance within single db transaction
